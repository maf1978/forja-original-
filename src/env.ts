...
export interface Env {
  ...
  // Hawk Guru-only Control Center password. This must be different from the
  // Realtor suite password and fails closed until it is configured.
  DASHBOARD_PASSWORD_Control_Center?: string;
